  ...
  return (
    <nav className="nav">
      <ul className="nav-list">
        <li>
          <Link href="/" prefetch aria-label="Home">
        ...
        <li>
          <Link href="/about" prefetch aria-label="About Me">
        ...
        <li>
          <Link href="/projects" prefetch aria-label="Projects">
        ...
        <li>
          <Link href="/endorsements" prefetch aria-label="Endorsements">
        ...
        <li>
          <Link href="/contact" prefetch aria-label="Contact Me">
